...
## SI 206 - W17 - HW5
## COMMENT WITH:
## Your section day/time: Thursday 3PM Section 002
...
cachefile_directory = "twitter_cache_HW5.json"
...
def cache_twitter(searchword):
    identifier = "search_{}".format(searchword)
